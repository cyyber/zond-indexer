...
func getBurnPageData() (*types.BurnPageData, error) {
	...
	income, err := db.MongodbClient.GetValidatorIncomeDetailsHistory([]uint64{}, latestEpoch-10, latestBlock)
	if err != nil {
	...
	blocks, err := db.MongodbClient.GetBlocksDescending(latestBlock, 1000)
	if err != nil {
		return nil, err
	}
...
func getGasNowData() (*types.GasNowPageData, error) {
	...
	err = db.MongodbClient.SaveGasNowHistory(gpoData.Data.Slow, gpoData.Data.Standard, gpoData.Data.Fast, gpoData.Data.Rapid)
	if err != nil {
