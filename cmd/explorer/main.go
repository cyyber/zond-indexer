...
func main() {
	...
	if cfg.Frontend.Enabled {
		...
		router.GET("/validator/:index", handlers.Validator)
		router.GET("/validator/:index/proposedblocks", handlers.ValidatorProposedBlocks)
		router.GET("/validator/:index/attestations", handlers.ValidatorAttestations)
		router.GET("/validator/:index/withdrawals", handlers.ValidatorWithdrawals)
		router.GET("/validator/:index/sync", handlers.ValidatorSync)
		router.GET("/validator/:index/history", handlers.ValidatorHistory)
		router.GET("/validator/:index/deposits", handlers.ValidatorDeposits)
		router.GET("/validator/:index/slashings", handlers.ValidatorSlashings)
		router.GET("/validator/:index/effectiveness", handlers.ValidatorAttestationInclusionEffectiveness)
		router.POST("/validator/:index/save", handlers.ValidatorSave)
		// router.POST("/watchlist/add", handlers.UsersModalAddValidator)
		// router.POST("/validator/:pubkey/remove", handlers.UserValidatorWatchlistRemove)
		router.GET("/validator/:index/stats", handlers.ValidatorStatsTable)
		router.GET("/validators", handlers.Validators)
		router.GET("/validators/data", handlers.ValidatorsData)
		router.GET("/validators/slashings", handlers.ValidatorsSlashings)
		router.GET("/validators/slashings/data", handlers.ValidatorsSlashingsData)
		router.GET("/validators/leaderboard", handlers.ValidatorsLeaderboard)
		router.GET("/validators/leaderboard/data", handlers.ValidatorsLeaderboardData)
		router.GET("/validators/streakleaderboard", handlers.ValidatorsStreakLeaderboard)
		router.GET("/validators/streakleaderboard/data", handlers.ValidatorsStreakLeaderboardData)
		router.GET("/validators/withdrawals", handlers.Withdrawals)
		router.GET("/validators/withdrawals/data", handlers.WithdrawalsData)
		router.GET("/validators/withdrawals/bls", handlers.BLSChangeData)
		router.GET("/validators/deposits", handlers.Deposits)
		router.GET("/validators/initiated-deposits/data", handlers.Eth1DepositsData)
		router.GET("/validators/deposit-leaderboard", handlers.Eth1DepositsLeaderboard)
		router.GET("/validators/deposit-leaderboard/data", handlers.Eth1DepositsLeaderboardData)
		router.GET("/validators/included-deposits/data", handlers.Eth2DepositsData)
